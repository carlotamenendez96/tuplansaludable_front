...
export const DumbbellIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="m6.5 6.5 11 11" /><path d="m21 21-1-1" /><path d="m3 3 1 1" /><path d="m18 22 4-4" /><path d="m6 2 4 4" /><path d="m3 10 4-4" /><path d="m21 14 4-4" /><rect width="5" height="5" x="14" y="2" rx="1" /><rect width="5" height="5" x="5" y="17" rx="1" />
  </svg>
);
...
export const ChefHatIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12 2a5 5 0 0 0-5 5v2h10V7a5 5 0 0 0-5-5Z" /><path d="M6 11h12v9a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2v-9Z" /></svg>
);

export const SparklesIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m12 3-1.5 3-3 1.5 3 1.5 1.5 3 1.5-3 3-1.5-3-1.5Z" /><path d="M3 12h1.5" /><path d="M19.5 12H21" /><path d="M6.34 17.66 7.5 16.5" /><path d="M16.5 7.5 17.66 6.34" /><path d="m12 21 1.5-3 3-1.5-3-1.5-1.5-3-1.5 3-3 1.5 3 1.5Z" /></svg>
);
